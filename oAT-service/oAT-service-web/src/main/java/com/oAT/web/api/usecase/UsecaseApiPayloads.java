...
public final class UsecaseApiPayloads {
    ...
    public static class SaveUsecaseRequest {
        ...
        private List<String> coverageFootprints;
        ...
        public List<String> getCoverageFootprints() { return coverageFootprints; }
        public void setCoverageFootprints(List<String> coverageFootprints) { this.coverageFootprints = coverageFootprints; }
