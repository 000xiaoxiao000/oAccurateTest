...
<div id="aiFloatingWidget"
    ...
    <div id="aiFloatingPanel" class="ai-floating-panel">
        ...
        <div class="ai-floating-layout-canvas">
            <div class="ai-floating-layout-item ai-floating-layout-section" id="aiFloatingMessageSection" data-layout-key="message" data-default-left="16" data-default-top="66" data-default-width="348" data-default-height="170" data-min-width="220" data-min-height="120">
                <div class="ai-floating-layout-handle ai-floating-section-header">
                ...
                <div class="ai-floating-layout-resize" title="调整大小"></div>
            </div>

            <div id="aiFloatingContextStatus" class="ai-floating-layout-item ai-floating-context-status" data-layout-key="context" data-default-left="16" data-default-top="246" data-default-width="348" data-default-height="64" data-min-width="220" data-min-height="48">
                <div class="ai-floating-layout-handle ai-floating-layout-mini-handle">上下文</div>
                <div class="ai-floating-layout-resize" title="调整大小"></div>
            </div>

            <div class="ai-floating-layout-item ai-floating-layout-section" id="aiFloatingQuickLinkSection" data-layout-key="quickLinks" data-default-left="16" data-default-top="320" data-default-width="348" data-default-height="108" data-min-width="220" data-min-height="84">
                <div class="ai-floating-layout-handle ai-floating-section-header">
            ...
            <div class="ai-floating-layout-item ai-floating-layout-section" id="aiFloatingStarterSection" data-layout-key="starter" data-default-left="16" data-default-top="438" data-default-width="348" data-default-height="86" data-min-width="220" data-min-height="72">
                <div class="ai-floating-layout-handle ai-floating-section-header">
            ...
            <div class="ai-floating-layout-item ai-floating-compose" data-layout-key="compose" data-default-left="16" data-default-top="534" data-default-width="348" data-default-height="132" data-min-width="240" data-min-height="116">
                <div class="ai-floating-layout-handle ai-floating-layout-mini-handle">输入区</div>
