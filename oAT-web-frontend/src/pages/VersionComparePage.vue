<template>
  <section>
    ...
    <VersionCoverageReportsPanel
      v-model:page="coverageReportPage"
      v-model:page-size="coveragePageSize"
      v-model:collapsed="coverageReportsCollapsed"
      :project-id="projectId"
      :app-id="appId"
      :reports="paginatedCoverageReports"
      :total-count="center?.coverageReports.length || 0"
      :busy="busy"
      :short-text="shortText"
      :commit-tooltip="commitTooltip"
      :coverage-percent="coveragePercent"
      @delete="removeCoverage"
    />
...
import { deleteCoverageReportV2 } from '@/features/coverage/api/core'
...
import VersionCoverageReportsPanel from '@/features/version/components/VersionCoverageReportsPanel.vue'
