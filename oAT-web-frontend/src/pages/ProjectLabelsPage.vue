    ...
    <template v-else-if="payload">
      <div class="label-grid">
        ...
        <section class="label-card">
          ...
          <div class="chips">
            <button
              v-for="label in payload.snapshotLabels"
          ...
          <div class="form-row">
            <input v-model="snapshotName" class="text-input" type="text" placeholder="新标签名称" />
            <select v-model="snapshotColor" class="select">
              <option v-for="item in colors" :key="item.name" :value="item.name">{{ item.name }}</option>
            </select>
            <button class="primary-button" type="button" @click="save('snapshot', snapshotName, snapshotColor)">
              保存
            </button>
          </div>
        </section>
