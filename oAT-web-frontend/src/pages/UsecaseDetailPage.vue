      ...
      <div class="hero-card">
        <div class="hero-main">
          ...
          <div class="meta-grid">
            ...
            <div class="meta-item">
              <span>快照</span>
              <strong>{{ payload.snapshots?.length || 0 }}</strong>
            </div>
            <div class="meta-item">
              <span>系统快照</span>
              <strong>{{ payload.systemSnapshots?.length || 0 }}</strong>
            </div>
          </div>
        </div>
      ...
      <div class="detail-grid">
        ...
        <aside class="side-stack">
          <section class="side-card">
            ...
            <div v-if="!payload.snapshots?.length" class="empty-card compact">暂无关联快照</div>
          ...
          <section class="side-card">
            ...
            <div v-if="!payload.systemSnapshots?.length" class="empty-card compact">暂无系统快照</div>
            <div v-else class="item-list">
              <a
                v-for="item in payload.systemSnapshots"
                :key="item.id"
