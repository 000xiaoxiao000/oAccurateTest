...
.project-grid.list-view .project-card {
  display: grid;
  grid-template-columns: minmax(220px, 0.9fr) minmax(240px, 1fr) minmax(360px, 1.45fr) auto;
  gap: 14px 18px;
  align-items: center;
}

.project-grid.list-view .inline-form {
  grid-column: 1 / -1;
}
...
.project-grid:not(.list-view) .project-card-actions {
  padding-top: 2px;
