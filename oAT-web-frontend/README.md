...
`oAT-web-frontend` 是 oAccurateTest 的 Web 操作界面，基于 Vue 3、TypeScript 和 Vite 构建。它提供项目管理、应用配置、链路监控、系统快照、覆盖率报告、版本中心、用例中心、API 端点分析和 AI 对话等页面。
...
| 探针与链路 | 在线应用、实时监控、探针告警、链路详情 |
| 快照 | 系统快照、个人快照、快照图谱、快照覆盖率、源码着色、分享页 |
| 覆盖率 | 报告中心、报告概览、类/方法明细、源码着色、版本报告详情 |
| 版本 | 版本列表、创建版本、关联应用、版本差异对比 |
| 用例 | 用例列表、详情、编辑、分享 |
| 分析 | API 端点覆盖、代码关系图谱、全局搜索、AI 智能分析 |
| 账号 | 登录、注册、账号设置 |

覆盖率中心支持 Java Agent 快照覆盖率、前端 Istanbul 覆盖率，以及 Go / Python / C/C++ 通用覆盖率。
