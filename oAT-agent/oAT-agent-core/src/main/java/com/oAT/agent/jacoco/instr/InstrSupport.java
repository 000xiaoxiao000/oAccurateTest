...
public final class InstrSupport {
    private final static Log logger = LogFactory.getLog(InstrSupport.class);
     ...
     * {@link com.oAT.shaded.asm97.commons.GeneratorAdapter#push(int)}.
     *
    ...
    public static ProbeCounter getProbeCounter(final ClassReader reader) {
        ...
        try {
            ...
            logger.error("[Agent-getProbeCounter]Error creating ProbeCounter: " + e);
            return null;
        }
