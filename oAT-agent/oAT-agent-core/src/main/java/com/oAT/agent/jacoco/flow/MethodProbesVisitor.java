...
public abstract class MethodProbesVisitor extends MethodVisitor {
	 ...
	 */
	@SuppressWarnings("unused")
	public void visitLookupSwitchInsnWithProbes(final Label dflt, final int[] keys, final Label[] labels, final IFrame frame) {
	}

	public void visitVarInsnWithProbes(final int opcode, final int var, final int probeId) {
	}

	public void visitFieldInsnWithProbes(final int opcode, final String owner, final String name, final String desc, final int probeId) {
	}

	public void visitMethodInsnWithProbes(final int opcode, final String owner, final String name, final String desc, final boolean itf,
										  final int probeId){}
